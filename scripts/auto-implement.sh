...
TASKS_FILE="./implementation-tasks.json"
PLAN_FILE="./implementation-phase-1.md"
DEV_LOG="./dev-log.txt"
...
- use jq to directly update ./implementation-tasks.json so the selected tasks are marked with status "active"
- after updating the file, respond with ONLY the selected task IDs as valid JSON
- respond with ONLY a JSON array of task IDs, for example: ["P1-T1","P1-T2"]
...
- keep work aligned with ./implementation-phase-1.md
